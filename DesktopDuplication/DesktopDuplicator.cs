...
namespace DesktopDuplication
{
	...
	public sealed class DesktopDuplicator
    {
        ...
        private void ProcessFrame(DesktopFrame frame)
        {
            ...
            var boundsRect = new System.Drawing.Rectangle(0, 0, mOutputDesc.DesktopBounds.Right - mOutputDesc.DesktopBounds.Left, mOutputDesc.DesktopBounds.Bottom - mOutputDesc.DesktopBounds.Top);
            // Copy pixels from screen capture Texture to GDI bitmap
            var mapDest = FinalImage.LockBits(boundsRect, ImageLockMode.WriteOnly, FinalImage.PixelFormat);
            var sourcePtr = mapSource.DataPointer;
            var destPtr = mapDest.Scan0;
            for (int y = 0; y < mOutputDesc.DesktopBounds.Bottom - mOutputDesc.DesktopBounds.Top; y++)
            {
                // Copy a single line 
                Utilities.CopyMemory(destPtr, sourcePtr, (mOutputDesc.DesktopBounds.Right - mOutputDesc.DesktopBounds.Left) * 4);
